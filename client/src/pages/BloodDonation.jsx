...
// ── Logo path: put your logo at client/public/images/logo.png ──────────────
...
function Certificate({ donor, certRef }) {
  ...
  return (
    <div ref={certRef} style={{
      ...
      background:"linear-gradient(160deg,#fff9f9 0%,#ffffff 60%,#fff5f5 100%)",
      ...
      <div style={{position:"absolute",top:"50%",left:"50%",
        ...
        fontSize:88,fontWeight:900,color:"rgba(183,28,28,0.035)",
        whiteSpace:"nowrap",zIndex:0,userSelect:"none",letterSpacing:8}}>
        BLOOD DONATION
      </div>

      {/* ── PHOTO — top right corner (passport style) ── */}
      ...
      <div style={{
        ...
        <div style={{display:"flex",alignItems:"center",gap:14,marginBottom:4,width:"100%",justifyContent:"center"}}>
          <svg width="30" height="36" viewBox="0 0 44 56">
          ...
          <img
            ...
            style={{width:56,height:56,objectFit:"contain",borderRadius:"50%",border:"2px solid #e57373"}}
            onError={e => { e.target.style.display="none"; }}
          />

          <div style={{textAlign:"center"}}>
            <div style={{fontSize:12,letterSpacing:3,color:"#b71c1c",fontWeight:800,textTransform:"uppercase"}}>
              Narayan Pur Bipader Bondhu Welfare Society
            </div>
            <div style={{fontSize:9,color:"#777",letterSpacing:1,marginTop:1}}>
        ...
        {/* ── Divider ── */}
        <div style={{width:"90%",height:2,background:"linear-gradient(90deg,transparent,#b71c1c,#e53935,#b71c1c,transparent)",margin:"4px 0"}}/>

        {/* ── Main title ── */}
        <h1 style={{
          fontSize:34,fontWeight:900,color:"#7f0000",
        ...
        {/* ── Description ── */}
        <p style={{fontSize:11.5,color:"#444",textAlign:"center",lineHeight:1.8,marginBottom:10,maxWidth:520}}>
        ...
        <div style={{display:"flex",gap:16,justifyContent:"center",marginBottom:10}}>
          {[
            ...
            <div key={label} style={{
              ...
              border:"1.5px solid #e57373",borderRadius:10,
        ...
        {/* ── Camp name + address row ── */}
        <div style={{display:"flex",gap:20,justifyContent:"center",marginBottom:6,flexWrap:"wrap"}}>
          {campName && (
            <div style={{
...
<div style={{width:"100%",display:"flex",justifyContent:"space-between",alignItems:"flex-end",padding:"0 20px"}}>
  ...
  {/* President */}
  <div style={{textAlign:"center"}}>
    <div style={{fontFamily:"'Brush Script MT','Dancing Script',cursive",fontSize:22,color:"#1a237e",marginBottom:3,letterSpacing:1}}>
      Tariful Mia
    </div>
    <div style={{width:120,height:1.5,background:"#333",margin:"0 auto 4px"}}/>
  ...
  <div style={{textAlign:"center"}}>
    ...
    <div style={{width:120,height:1.5,background:"#333",margin:"0 auto 4px"}}/>
    <div style={{fontSize:9,fontWeight:700,color:"#333",letterSpacing:1.5,textTransform:"uppercase"}}>Manager</div>
    <div style={{fontSize:7,color:"#777",marginTop:1}}>Narayan Pur Bipader Bondhu Welfare Society</div>
  </div>
