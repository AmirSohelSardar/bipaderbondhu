...
function Certificate({ donor, certRef }) {
  ...
  return (
    <div ref={certRef} style={{
      ...
      {/* ── Borders ── */}
      <div style={{position:"absolute",inset:12,border:"5px double #b71c1c",zIndex:1,pointerEvents:"none"}}/>
      <div style={{position:"absolute",inset:21,border:"1px solid #e57373",zIndex:1,pointerEvents:"none"}}/>
      ...
      {[{top:12,left:12},{top:12,right:12},{bottom:12,left:12},{bottom:12,right:12}].map((s,i)=>(
        <div key={i} style={{position:"absolute",...s,width:40,height:40,
          borderTop:(s.top!==undefined)?"3px solid #b71c1c":"none",
          borderBottom:(s.bottom!==undefined)?"3px solid #b71c1c":"none",
          borderLeft:(s.left!==undefined)?"3px solid #b71c1c":"none",
          borderRight:(s.right!==undefined)?"3px solid #b71c1c":"none",
          zIndex:2}}/>
      ))}
      ...
      <div style={{position:"absolute",top:"50%",left:"50%",
        ...
        fontSize:90,fontWeight:900,color:"rgba(183,28,28,0.03)",
        whiteSpace:"nowrap",zIndex:0,userSelect:"none",letterSpacing:6}}>
        BLOOD DONATION
      </div>
      ...
      <div style={{position:"absolute",top:32,right:32,zIndex:6}}>
        <div style={{
          ...
          {photoUrl
            ...
            : <svg width="55" height="65" viewBox="0 0 24 28" fill="#ccc">
      ...
      <div style={{
        ...
        {/* ── NGO header ── */}
        <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:3,width:"100%",justifyContent:"center"}}>
          {/* Left blood drop */}
          <svg width="22" height="28" viewBox="0 0 44 56">
          ...
          <img src={NGO_LOGO} alt="NGO Logo" crossOrigin="anonymous"
            style={{width:52,height:52,objectFit:"contain",borderRadius:"50%",border:"2px solid #e57373"}}
          ...
          <div style={{textAlign:"center"}}>
            ...
            <div style={{fontSize:8.5,color:"#777",letterSpacing:0.5,marginTop:2}}>
              Govt. Registered NGO • Reg. No: S0042589 of 2024–2025
            </div>
            <div style={{fontSize:7.5,color:"#999",letterSpacing:0.3,marginTop:1}}>
              {NGO_ADDRESS}
            </div>
          </div>
        ...
        {/* ── Divider ── */}
        <div style={{width:"92%",height:2,background:"linear-gradient(90deg,transparent,#b71c1c,#e53935,#b71c1c,transparent)",margin:"3px 0"}}/>
        ...
        <p style={{fontSize:12,color:"#888",fontStyle:"italic",margin:"2px 0 4px"}}>
        ...
        <div style={{display:"flex",gap:14,justifyContent:"center",marginBottom:8}}>
          {[
            ...
            <div key={label} style={{
              ...
              <div style={{fontSize:8,color:"#b71c1c",letterSpacing:1.5,textTransform:"uppercase",fontWeight:700,marginBottom:4}}>
                {label}
              </div>
              <div style={{fontSize:17,fontWeight:800,color:"#1a1a1a"}}>{value}</div>
            </div>
          ))}
        </div>

        {/* ── Camp name + address ── */}
        <div style={{display:"flex",gap:14,justifyContent:"center",marginBottom:6,flexWrap:"wrap"}}>
          {campName && (
            <div style={{
              display:"flex",alignItems:"center",gap:6,
              background:"linear-gradient(135deg,#fff0f0,#fff)",
              border:"1px solid #e57373",borderRadius:8,
              padding:"5px 14px",
              boxShadow:"0 1px 4px rgba(183,28,28,0.08)",
            }}>
              <span style={{fontSize:13}}>🏕️</span>
              <div>
                <div style={{fontSize:8,color:"#b71c1c",letterSpacing:1.5,textTransform:"uppercase",fontWeight:700}}>Camp Name</div>
                <div style={{fontSize:12,fontWeight:700,color:"#1a1a1a"}}>{campName}</div>
              </div>
            </div>
          )}
          {address && (
            <div style={{
              ...
              <div style={{fontSize:11,color:"#666"}}>{address}</div>
            </div>
          )}
        </div>

        {/* ── Divider ── */}
        <div style={{width:"92%",height:1,background:"linear-gradient(90deg,transparent,#e57373,transparent)",margin:"4px 0 6px"}}/>

        {/* ── Signatures — President + Seal + Secretary only ── */}
        <div style={{width:"100%",display:"flex",justifyContent:"space-between",alignItems:"flex-end",padding:"0 30px"}}>

          {/* President */}
          <div style={{textAlign:"center"}}>
            <div style={{
              fontFamily:"'Brush Script MT','Dancing Script',cursive",
              fontSize:24,color:"#1a237e",marginBottom:3,letterSpacing:1,
            }}>
              Tariful Mia
            </div>
            <div style={{width:130,height:1.5,background:"#333",margin:"0 auto 4px"}}/>
            <div style={{fontSize:9,fontWeight:700,color:"#333",letterSpacing:1.5,textTransform:"uppercase"}}>President</div>
          ...
          <div style={{textAlign:"center",display:"flex",flexDirection:"column",alignItems:"center"}}>
            <div style={{
              ...
              <div style={{fontSize:7,fontWeight:900,color:"#b71c1c",letterSpacing:2,textTransform:"uppercase",marginBottom:2,opacity:0.7}}>
                CERTIFIED
              </div>
              <div style={{fontSize:13,fontWeight:900,color:"#b71c1c",letterSpacing:1.5,textTransform:"uppercase",fontFamily:"'Times New Roman',serif",lineHeight:1}}>
                ✓ APPROVED
              </div>
              <div style={{fontSize:6,fontWeight:700,color:"#b71c1c",letterSpacing:1,marginTop:2,opacity:0.7}}>
                2026
              </div>
            </div>
          </div>
          ...
          <div style={{textAlign:"center"}}>
            ...
            <div style={{width:130,height:1.5,background:"#333",margin:"0 auto 4px"}}/>
            <div style={{fontSize:9,fontWeight:700,color:"#333",letterSpacing:1.5,textTransform:"uppercase"}}>Secretary</div>
            <div style={{fontSize:7,color:"#777",marginTop:1}}>Narayan Pur Bipader Bondhu Welfare Society</div>
          </div>
